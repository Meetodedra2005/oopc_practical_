...
int main()
{
    ...
    while (1)
    {
        ...
        case 1:
            ...
            for (i = 0; i < te_emp; i++)
            {
                ft = teaching_emp[i].findid(id_temp, ft);
                if (ft == 1)
                {
                    teaching_emp[i].putdata_t();
                    break;
                }
            }
            ...
            for (i = 0; i < nte_emp; i++)
            {
                fnt = non_teach_emp[i].findid(id_temp, fnt);
                if (fnt == 1)
                {
                    non_teach_emp[i].putdata_n_t();
                    break;
                }
            }
